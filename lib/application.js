...
app.defaultConfiguration = function() {
  // Detect if we're in the browser or on the server
  this.set('platform', (typeof window == "undefined")?"server":"client");
  // default settings
  // TODO how do we figure out the env?
...
/**
 * Proxy `stack#use()` to apply settings to
...
app.use = function(route, fn){
  ...
  stack.proto.use.call(this, route, fn);
